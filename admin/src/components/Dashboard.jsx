      ...
      <div className="div3">
        <div className="topcards">
          <div className="detailcardBtns">
            <button className="detailBtn">Collectin Routes</button>
            <button className="detailBtn">Collectin Schedule</button>
            <button className="detailBtn">View Waste Collection</button>
