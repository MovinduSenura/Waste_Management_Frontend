  ...
  return (
    <div className="map-container">
      ...
      <div className="bg-white rounded-t-3xl z-20">
        ...
        <div className="mt-3 ml-5 w-[90%] bg-white p-2 flex justify-between space-x-6 shadow-lg rounded-md">
          <img src={RouteImg} />
          <div className="flex space-x-6 pr-4 pt-2">
            <h1>route</h1>
            <h1>date</h1>
            <h1 onClick={() => navigate("/collectorreportpage")}>report</h1>
          </div>
        </div> 
        <div className="mt-3 ml-5 w-[90%] bg-white p-2 flex justify-between space-x-6 shadow-lg rounded-md">
          <img src={RouteImg} />
