      ...
      <div className="bg-[#2F5944] p-6 relative h-[180px]">
        <div className="flex justify-between mt-7">
          ...
          {/* <img
            src={ProfileImg}
            alt="Profile"
            className="w-12 h-12 rounded-full border-2 border-white mt-1"
          /> */}
        </div>
      </div>
      ...
      <div className="bg-white rounded-t-[35px] z-10 -mt-7">
        ...
        <div className="flex justify-around mt-5 mb-0 px-4 py-6">
          <div className="bg-white p-4 rounded-lg w-[55%] text-center inline-flex">
            <div>
              <img src={Bin} alt="Bins" className="w-10 h-10 mx-auto mb-2" />
            </div>
            <div>
              <p className="text-sm text-gray-500">Bins To Be Collected</p>
              <p className="text-lg font-semibold text-left">380 Bins</p>
            </div>
          </div>

          <div className="bg-white p-4 rounded-lg w-[45%] text-center inline-flex">
            <div>
              <img src={Route} alt="Route" className="w-10 h-10 mx-auto mb-2" />
            </div>
            <div className="ml-2">
              <p className="text-sm text-gray-500">Distance</p>
              <p className="text-lg font-semibold text-left">120 km</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-transparent mx-4 p-2 rounded-xl flex flex-col items-center relative">
          ...
          <div className="bg-gray-100 bg-opacity-80 p-4 rounded-2xl w-[85%] border border-black absolute bottom-5">
            <p className="font-semibold ml-4">Waste Pick Up Route</p>
            <p className="text-gray-500 ml-4">Today's Schedule</p>
